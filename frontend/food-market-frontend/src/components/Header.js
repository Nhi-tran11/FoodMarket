      ...
      <div className="header-container">
        <div className="logo-section">
          <Link to="/" className="logo">
            <span className="logo-text">FOOD MARKET</span>
          </Link>
        ...
        <nav className={`nav ${isMenuOpen ? 'nav-open' : ''}`}>
          ...
          >
            <button className="dropbtn nav-link menu-link">
              MENU
            </button>
            <div className="dropdown-content">
              <Link to="/FoodList?category=food" onClick={() => { setIsMenuOpen(false); setIsDropdownOpen(false); }}>
                🍽️ Food
              </Link>
              <Link to="/FoodList?category=drink" onClick={() => { setIsMenuOpen(false); setIsDropdownOpen(false); }}>
                🥤 Drink
              </Link>
              <Link to="/FoodList?category=dessert" onClick={() => { setIsMenuOpen(false); setIsDropdownOpen(false); }}>
                🍰 Dessert
              </Link>
            </div>
          </div>
          <Link to="/promotion-products" className="nav-link promos-link" onClick={() => setIsMenuOpen(false)}>
            PROMOS
          </Link>
          <Link to="/" className="nav-link about-link" onClick={() => setIsMenuOpen(false)}>
            ABOUT US
          </Link>
        </nav>
