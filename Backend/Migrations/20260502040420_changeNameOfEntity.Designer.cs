...
namespace Backend.Migrations
{
    ...
    [Migration("20260502040420_changeNameOfEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Model.Discount", b =>
                {
                    b.HasOne("Backend.Model.Customer", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Model.ReferalCode", b =>
                {
                    b.HasOne("Backend.Model.Customer", "ReceivedByUser")
                        .WithMany("ReferalCodes")
                        .HasForeignKey("ReceivedByUserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Backend.Model.Customer", "Referrer")
                        .WithMany()
